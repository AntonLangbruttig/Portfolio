...
const projects = [
  ...
  },
  {
    ...
    goto: "/",
    github: "https://github.com/AntonLangbruttig/Portfolio",
  },
];
  ...
  return (
    <div
      className={`h-screen flex flex-col md:w-[1000px]  sm:justify-start sm:items-start md:[align-items:unset] sm:pl-0
        sm:w-full md:h-max md:pl-[15px] md:pr-10 mr-64 transition-opacity duration-1000 relative z-[100] ${
          ...
          >
            ...
            {projects.map((project, index) => (
              <div
                ...
                md:mt-0 md:w-[600px] md:min-w-[600px] md:max-w-none md:h-[350px] md:mb-0 z-[100]"
              >
                <Link href={project.link} className="block mb-3 md:h-full  overflow-hidden">
                  {project.video ? (
                    <>
                      {/* Desktop Video */}
                      <video
                    ...
                    <>
                      <Image
                        ...
                        height={250}
                        priority={true}
                        className={`hidden sm:hidden md:block rounded-none w-full h-full min-h-[150px]  ${
                          project.title === "PDF Data Extractor" ? "object-top -translate-y-8" : "lg:object-center object-center"
                        }`}
                      />
                      <Image
                        ...
                        height={100}
                        priority={true}
                        className={`hidden sm:block md:hidden lg:hidden rounded-none w-full h-[430px] object-fit ${
                          project.title === "TA App" ? "object-right" :
                          project.title === "PDF Data Extractor" ? "object-top -translate-y-3" : "object-top"
                        }`}
                      />
                    </>
                  )}
                ...
                <div
                  className={`absolute bottom-0 left-0 right-0 bg-black bg-opacity-90 p-2 md:h-[50px] ${
                ...
                >
                  ...
                  <div className="md:absolute bottom-[10px] right-2 flex md:space-x-2 sm:ml-[1px] sm:justify-center
                   md:flex-row sm:flex-row sm:flex-wrap sm:gap-[4px] md:flex-nowrap md:gap-0">
                    {/* More Info Button */}
                    <Link
                      href={project.moreInfoLink}
                      className={`bg-[#059ec9] text-white text-sm font-medium py-[6px]
                      md:px-3 sm:mr-0 sm:px-[10px] md:mt-0 sm:py-1 rounded-none hover:bg-cyan-700
                      transition sm:text-center sm:w-[calc(50%-2px)] ${
                        project.title === "Portfolio Website" ? "sm:mt-1" : "sm:mt-0"
                      } md:w-auto`}
                    >
                      More Info
                    </Link>
                    ...
                    {(project.title === "Portfolio Website" ||
                      ...
                      <a
                        ...
                        sm:mr-0 sm:px-[10px] sm:py-1 md:mt-0 rounded-none hover:bg-cyan-700
                    ...
                    {/* GitHub Button - Full Width Version (for Portfolio & TA App) */}
                    {project.github && (project.title === "Portfolio Website") && (
                      <a
                        href={project.github}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="bg-[#059ec9] text-white text-sm font-medium py-[6px] md:px-3
                        sm:mr-0 sm:px-[10px] sm:py-1 rounded-none hover:bg-cyan-700
                        transition sm:text-center flex items-center justify-center gap-1 md:w-auto md:mt-0
                        sm:w-full sm:mt-1"
                      >
                    ...
                    {/* GitHub Button - Half Width Version (for PDF Data Extractor) */}
                    {project.github && (project.title === "PDF Data Extractor" || project.title === "TA App" ) && (
                      <a
                        href={project.github}
                        target="_blank"
                        rel="noopener noreferrer"
