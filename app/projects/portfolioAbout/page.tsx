      ...
      >
        <div className="min-h-fit md:min-h-[calc(100%+110px)]">
          ...
          >
            ...
            >
              Personal portfolio with synchronized boot animations, vintage CRT effects, and serverless backend.
            </p>
            ...
            <div className="mb-6">
              <div className="mb-6">
                ...
                <ul 
                  ...
                  style={{ paddingLeft: isSmallScreen ? '0' : '45px' }}
                >
                  <li>{">"} Custom boot sequence with SVG line-draw animations and typewriter effect</li>
                  <li>{">"} CRT effects (scanlines, RGB shift, screen glow) built with pure CSS</li>
                  <li>{">"} Dark/light theme toggle with React Context state management</li>
                  <li>{">"} Responsive across 7 breakpoints with separate mobile/desktop layouts</li>
                  <li>{">"} Serverless contact form with AWS SES and Redis rate limiting</li>
                  <li>{">"} Framer Motion animations for mobile menu transitions</li>
                  <li ref={lastListItemRef}>{">"} CI/CD deployment via GitHub to AWS Amplify<span className="animate-blink"> __</span></li>
                </ul>
              </div>
            </div>
