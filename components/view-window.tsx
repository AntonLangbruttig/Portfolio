      ...
      <div className="w-full lg:ml-2 sm:ml-0 sm:-mr-1 h-[85vh] lg:h-[70vh] lg:mt-[90px] sm:h-[9vh] overflow-visible ">
        <div className="relative w-full flex-row items-center justify-center bg-fixed">
          ...
          >
            ...
            <div className={`sm:flex  sm:flex-col wrap relative w-full md:h-full aspect-video rounded-none overflow-hidden shadow-lg 
                ${animationState === "content" ? "screen-on" : ""} sm:h-screen sm:overflow-none flex-wrap `}>
              ...
              <div className={`absolute inset-x-0 flex h-[470px] sm:min-h-min overflow-hidden `} style={{ zIndex: 2 }}>
                <div className="p-1  h-screen flex flex-col w-screen sm:h-screen z-40">
                    {children}
                </div>
              </div>
              {showNav && (
